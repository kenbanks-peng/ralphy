...
export function createProgram(): Command {
	...
	program
		.name("ralphy")
		.description(
			"Autonomous AI Coding Loop - Supports Claude Code, OpenCode, Codex, Cursor, Qwen-Code, Factory Droid, GitHub Copilot, Gemini CLI and Pi",
		)
		.version(VERSION)
